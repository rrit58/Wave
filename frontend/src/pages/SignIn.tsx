...
const Login = () => {
  ...
  return (
    <div className={`flex min-h-screen items-center justify-center relative overflow-hidden p-4 sm:p-8`}>
      ...
      {/* Login Card */}
      <section className="relative z-10 w-full max-w-[420px] rounded-3xl overflow-hidden border border-border bg-card text-card-foreground shadow-2xl p-8 sm:p-10 animate-in fade-in zoom-in-95 duration-500">
        {/* Heading */}
        <div className="flex flex-col space-y-2 text-center mb-8">
          <h2 className="text-3xl font-bold tracking-tight text-foreground drop-shadow-sm">Welcome Back!</h2>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2 group">
            <div className="flex items-center justify-between">
              ...
              <Link to="/forget-password" className="text-sm font-medium text-muted-foreground hover:text-foreground hover:underline underline-offset-4 transition-colors">Forgot password?</Link>
            </div>
        ...
        <div className="text-center text-sm text-muted-foreground pt-6">
          ...
          <Link to="/register" className="font-semibold text-foreground hover:underline underline-offset-4 transition-colors cursor-pointer">
            Sign up
          </Link>
        </div>
      </section>
